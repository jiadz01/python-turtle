# Snake Game by Mahesh Sawant   网上下载原程序  作者: Mahesh Sawant
#
...
while True:
    ...
    # Check for a collision with the border 检查头部是否与边框碰撞
    if head.xcor()>290 or head.xcor()<-290 or head.ycor()>290 or head.ycor()<-290:
        time.sleep(1)
        head.goto(0,0)
        head.direction="stop" #未触发按键驱动事件前,头部停止不移动

        # Hide the segments  遍历列表,隐藏身体部份显示
    ...
    #Check for a collision with the food 检测是否吃到食物
